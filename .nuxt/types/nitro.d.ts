...
declare module 'nitropack' {
  ...
  interface InternalApi {
    '/api/user-validation': Awaited<ReturnType<typeof import('../../server/api/user-validation.post').default>>
    '/api/request-delegation': Awaited<ReturnType<typeof import('../../server/api/request-delegation').default>>
    '/api/delete-domain': Awaited<ReturnType<typeof import('../../server/api/delete-domain.post').default>>
    '/api/check-domain': Awaited<ReturnType<typeof import('../../server/api/check-domain.post').default>>
    '/api/add-domain': Awaited<ReturnType<typeof import('../../server/api/add-domain.post').default>>
    '/api/_supabase/session': Awaited<ReturnType<typeof import('../../server/api/_supabase/session.post').default>> | Awaited<ReturnType<typeof import('../../node_modules/@nuxtjs/supabase/dist/runtime/server/api/session').default>>
    '/og/:slug': Awaited<ReturnType<typeof import('../../server/routes/og/[slug]').default>>
...
declare global {
  ...
  const cachedEventHandler: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useQuery: typeof import('h3')['useQuery']
  const useRawBody: typeof import('h3')['useRawBody']
  const useRuntimeConfig: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useStorage: typeof import('/Users/bon/Documents/my-workspace/perfect-blog/node_modules/nitropack/dist/runtime')['useStorage']
