...
const useCustomHead = (title, description, image) => {
  useHead({
    ...
    meta: [
      ...
      { name: "twitter:image", content: image != null ? image : "https://perfect-blog.vercel.app/og.png" },
      ...
      { property: "og:image", content: image != null ? image : "https://perfect-blog.vercel.app/og.png" },
      { property: "og:image:secure_url", content: image != null ? image : "https://perfect-blog.vercel.app/og.png" },
...
//# sourceMappingURL=head.1997bdc2.js.map
