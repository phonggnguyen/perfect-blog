...
export const useCustomHead = (
  ...
  useHead({
    ...
    meta: [
      ...
      { name: 'twitter:title', content: title ?? 'KBlog | Write your blog with keyboard only experience' },
      {
        name: 'twitter:description',
        content:
          description ?? 'An open-source blogging platform + free custom domains. Powered by Nuxt 3, Supabase & Vercel',
      },
      { name: 'twitter:image', content: image ?? 'https://meetoon.co/og.png' },
      ...
      { property: 'og:image', content: image ?? 'https://meetoon.co/og.png' },
      { property: 'og:image:secure_url', content: image ?? 'https://meetoon.co/og.png' },
