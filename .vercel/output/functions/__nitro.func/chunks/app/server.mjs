import { openBlock, createElementBlock, mergeProps, createCommentVNode, withModifiers, normalizeClass, Fragment as Fragment$1, renderList, renderSlot, withKeys, createTextVNode, toDisplayString, createElementVNode, toRefs, getCurrentInstance, ref, computed, watch, nextTick, onMounted, onServerPrefetch, toRef, isRef, inject, defineComponent, provide, h, Suspense, Transition, reactive, unref, useSSRContext, createApp, withCtx, createVNode, createBlock, defineAsyncComponent, resolveComponent, watchEffect, markRaw, shallowRef, withDirectives, vModelText, getCurrentScope, onScopeDispose, readonly, onErrorCaptured } from 'vue';
...
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderSuspense } from 'vue/server-renderer';
...
import { Slice, Fragment as Fragment$2 } from 'prosemirror-model';
  ...
  return (openBlock(), createElementBlock("div", mergeProps({
    ...
    ($props.mode == 'tags')
      ? (openBlock(), createElementBlock("div", {
          ...
          (openBlock(true), createElementBlock(Fragment$1, null, renderList(_ctx.iv, (option, i, key) => {
    ...
    createElementVNode("div", {
      ...
      createElementVNode("ul", {
        ...
        ($props.groups)
          ? (openBlock(true), createElementBlock(Fragment$1, { key: 0 }, renderList(_ctx.fg, (group, i, key) => {
              return (openBlock(), createElementBlock("li", {
                ...
                createElementVNode("ul", {
                  ...
                  (openBlock(true), createElementBlock(Fragment$1, null, renderList(group.__VISIBLE__, (option, i, key) => {
                    return (openBlock(), createElementBlock("li", {
          ...
          : (openBlock(true), createElementBlock(Fragment$1, { key: 1 }, renderList(_ctx.fo, (option, i, key) => {
              return (openBlock(), createElementBlock("li", {
    ...
    ($props.nativeSupport)
      ? (openBlock(), createElementBlock(Fragment$1, { key: 9 }, [
          ($props.mode == 'single')
            ? (openBlock(), createElementBlock("input", {
                key: 0,
                type: "hidden",
            ...
            : (openBlock(true), createElementBlock(Fragment$1, { key: 1 }, renderList(_ctx.plainValue, (v, i) => {
...
function mapChildren(node, callback) {
  ...
  for (let i = 0; i < node.childCount; i++) {
    array.push(callback(node.child(i), i, node instanceof Fragment$2 ? node : node.content));
  }
  return array;
}
const moveNode = (type, dir) => {
  ...
  return (state, dispatch) => {
    ...
    const slice = new Slice(Fragment$2.fromArray(arr), 0, 0);
    ...
    children: [
      {
        ...
        meta: meta$c,
        alias: [],
        component: () => import('./_nuxt/domain.14214727.mjs').then((m) => m.default || m)
      },
      {
        name: "dashboard",
        path: "",
        ...
        meta: meta$b,
        alias: [],
        component: () => import('./_nuxt/index.9c6c2c14.mjs').then((m) => m.default || m)
      },
      {
        ...
        meta: meta$a,
        alias: [],
        component: () => import('./_nuxt/posts.e0c32c41.mjs').then((m) => m.default || m)
      },
      {
        ...
        meta: meta$9,
        alias: [],
        component: () => import('./_nuxt/profile.03149d45.mjs').then((m) => m.default || m)
      }
    ],
    meta: meta$d,
    alias: (meta$d == null ? void 0 : meta$d.alias) || [],
    component: () => import('./_nuxt/dashboard.730714c4.mjs').then((m) => m.default || m)
  },
  {
    name: "edit-id",
    path: "/edit/:id",
    ...
    component: () => import('./_nuxt/_id_.051584d6.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    meta: meta$7,
    alias: [],
    component: () => import('./_nuxt/index.809308b2.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    meta: meta$6,
    alias: [],
    component: () => import('./_nuxt/login.fdbd7a20.mjs').then((m) => m.default || m)
  },
  {
    name: "logout",
    path: "/logout",
    ...
    meta: meta$5,
    alias: [],
    component: () => import('./_nuxt/logout.6313b5bc.mjs').then((m) => m.default || m)
  },
  {
    name: "posts",
    path: "/posts",
    ...
    meta: meta$4,
    alias: [],
    component: () => import('./_nuxt/posts.b3523c25.mjs').then((m) => m.default || m)
  },
  {
    path: "/user/:siteId",
    ...
    children: [
      {
        ...
        meta: meta$2,
        alias: [],
        component: () => import('./_nuxt/_slug_.92036626.mjs').then((m) => m.default || m)
      },
      {
        ...
        meta: meta$1,
        alias: [],
        component: () => import('./_nuxt/home.f624a73a.mjs').then((m) => m.default || m)
      },
      {
        name: "user-siteId",
        path: "",
        ...
        meta,
        alias: [],
        component: () => import('./_nuxt/index.a1d39ff1.mjs').then((m) => m.default || m)
      }
    ],
    meta: meta$3,
    alias: (meta$3 == null ? void 0 : meta$3.alias) || [],
    component: () => import('./_nuxt/_siteId_.a6c6f82c.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import('./_nuxt/auth.1a3e37f5.mjs')
};
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.62e4a9ef.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import('./_nuxt/default.ef3db380.mjs').then((m) => m.default || m)),
  user: defineAsyncComponent(() => import('./_nuxt/user.a3e2be84.mjs').then((m) => m.default || m))
};
...
export { _sfc_main$g as _, __nuxt_component_0$1 as a, useSupabaseUser as b, useSupabaseClient as c, useMagicKeys as d, entry$1 as default, _export_sfc as e, useAsyncData as f, __nuxt_component_1 as g, useHead as h, useRoute as i, useLocalStorage as j, _sfc_main$f as k, _sfc_main$8 as l, _sfc_main$4 as m, navigateTo as n, _sfc_main$3 as o, __nuxt_component_3 as p, _sfc_main$2 as q, removeVietnameseTones as r, constructUrl as s, useSubdomainProfile as t, useState as u, useSubdomain as v, defineNuxtRouteMiddleware as w, __nuxt_component_1$1 as x, useRouter as y, _sfc_main$c as z };
