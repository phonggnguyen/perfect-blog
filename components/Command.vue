...
<template>
  <div>
    <button class="btn-plain" @click="isVisible = true">
      ⌘K
    </button>
    <Modal v-model:open="isVisible" class="!items-start" inner-class="!max-w-screen-sm rounded-xl mt-48">
      <div class="p-2">
        <div>
          <input
            v-model="searchTerm"
        ...
        <div class="py-6">
          ...
          <div v-else class="p-8 text-sm text-center">
            No results found.
          </div>
        </div>
      </div>
